...
#Enter State
@warning_ignore("unused_parameter")
func stateEnter(new_state, old_state):
	match(new_state):
...
func assign_animation():
	...
	p.animTree["parameters/conditions/Ledge"] = states.ledge
